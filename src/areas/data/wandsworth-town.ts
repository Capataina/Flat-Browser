...
const wandsworthTown: Area = {
  ...
  demographics: { primary_age_cohort: "30-39", age_breakdown: [], ethnic_composition: [], household_mix: [], student_pct: 0, professional_renter_pct: 0, notes: "Wandsworth Town ward: 20-39 50% — top-skew. Census 2021 plurality is 30-39 (prior 18-29 default was a sweep-level artefact). Ram Quarter / Wandsworth Riverside drive the mid-career professional pattern. Via CrystalRoof.", sources: [] },
