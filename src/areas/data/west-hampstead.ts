...
const westHampstead: Area = {
  ...
  projects: [
    buildProject({
      id: "west-hampstead-square", area_id: "west-hampstead", name: "West Hampstead Square", developer: "Ballymore", operator: "Ballymore", building_type: "Mixed", build_phase: "phased", tenure: ["rent", "buy"], realism: "unknown",
