...
const claphamJunction: Area = {
  ...
  connectivity: {
    ...
    redundancy_score: 5,
    notes: "Southern + SWR + Overground — three genuinely independent rail services at UK's busiest interchange by passenger numbers. Schema parity with King's Cross (3+ lines + rail alternative). Absence of tube is a speed/anchor issue (captured by multi_cluster_score: 1), not a redundancy issue. 17 platforms.",
    sources: [],
  },
