  ...
  projects: [
    {
      ...
      rental: {
        ...
        qualification: {
          ...
          notes: "Caner secured this with 3 months upfront instead of the standard 6-12. Greystar's in-house referencing accepted him as a graduate-visa renter without UK credit history on that basis. Post-RRA (1 May 2026), this upfront route closes for new tenancies — advance rent capped at 1 month.",
          sources: [],
        },
        cost_tier: "premium",
