...
const earlsCourt: Area = {
  ...
  long_form: {
    ...
    weekday: "Weekday mornings peak 07:30-09:00 with dense Piccadilly/District commuter flow. Earl's Court station becomes one of the busiest Zone 1 interchange stations at peak. Café culture wakes up 07:30 and runs through the day — Gail's (Earl's Court Road), Caffè Nero, multiple independents, Troubadour for the slower morning. Midday flow is a mix of commuter-returnees (limited daytime office cluster here — most workers travel to Westminster, City, West End), hotel guests, student population (Imperial College, Royal College of Art), and residents. Restaurant lunch traffic is moderate. Earl's Court Road's retail mix is working-class-meets-upmarket — a Waitrose 10 min walk, but also the cheap international-cuisine strip that the transient population supports. After 18:00 the evening turns over to dining-and-hotel traffic; by 22:00 the streets are quieter than Zone 1 core but busier than outer-zone residential. Night Tube Friday/Saturday maintains pedestrian flow until 02:00.",
    weekend: "Weekends shift toward tourism + weekend-service-industry. Saturday brings weekend shoppers to Waitrose/Sainsbury's, tourists arriving via Heathrow-Piccadilly, and a visible daytime mix of residents running weekend errands. The pub scene (Atlas, Hour Glass, Troubadour) fills in the evening but without the pre-2014 Exhibition Centre event-crowd bump. Sunday is gentler — Sunday lunch at the Atlas and the pub cluster, a steady flow in Brompton Cemetery's Sunday-walker demographic, and an uptick in the international-tourist flow. No major weekly market or festival anchors the calendar — unusual for a Zone 1 area. The AELTC's Championships fortnight (late June/early July) brings peripheral Earl's Court restaurant/bar trade, though Wimbledon is 20-25 min away by Piccadilly/District + overground.",
