...
This document reflects state as of 2026-04-17 after five major passes: the 2026-04-12 **sweep fold-in + data integrity pass**, the 2026-04-16 **realism schema redesign** + V1 **data-upkeep run** (266 projects populated across 92 operators, one ghost deletion), the 2026-04-17 **data-upkeep V2/V3/V4 scaffold + affordability field** (affordability as a profile-relative counterpart to cost_tier, end-to-end schema → UI; data-upkeep skill extended to cover enrichment, area research, and grade recalibration under flag-driven scope), and the 2026-04-17 **V2/V4 research wave** (15 parallel agents, 5 V2 operator enrichment batches + 10 V4 area research batches, ~5,700 field-level proposals written to `context/data-upkeep/proposals/` — 7 critical corrections applied to source, full enrichment apply staged for a follow-up session; run report at `context/data-upkeep/runs/2026-04-17-full.md`).
